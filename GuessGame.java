public class GuessGame {
	...
	public void startGame() {
		...
		while(true) {
			...
			// cheack each player's guess to see if it matches the target number. if a player is right, then set that player's variable to be true (remember, we set it false by default)
			...
			if (p1isRight || p2isRight || p3isRight) {
				...
				// otherwise, stay in the loop and ask the players for another game.
			} else {
